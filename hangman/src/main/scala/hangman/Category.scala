  ...
  case AnimalsHard
      extends Category(
        List(
          ...
          (
            "porcupine",
            "Large rodent with defensive spines or quills on the body and tail"
          )
        )
      )
  ...
  case CountriesHard
      extends Category(
        List(
          (
            "argentina",
            "A country in South America that is famous for its football"
          ),
          ("belgium", "A country in Western Europe famous for its waffles"),
          (
            "colombia",
            "A country in South America that is famous for its coffee culture"
          ),
          (
            "denmark",
            "The capital of this country is called the \"City of a Hundred Spires\""
          )
        )
      )
